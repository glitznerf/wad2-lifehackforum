# Generated by Django 2.2.17 on 2021-04-03 16:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(default='default.jpg', upload_to='hackImages')),
                ('categoryName', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='forum.Category')),
                ('user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='forum.UserAccount')),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
